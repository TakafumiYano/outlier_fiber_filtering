...
for Subject in $Subjlist ; do
  ...
  T1wImage="${StudyFolder}/${Subject}/T1w/T1w_acpc.nii.gz" #T1w FreeSurfer Input (Full Resolution)
  T1wImageBrain="${StudyFolder}/${Subject}/T1w/T1w_acpc_brain.nii.gz" #T1w FreeSurfer Input (Full Resolution)
